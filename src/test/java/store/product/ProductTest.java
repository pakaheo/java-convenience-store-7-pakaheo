...
public class ProductTest {
    ...
    @Test
    void 상품_생성() {
        Product coke = new Product("콜라", 1_000, 10, Constants.TWO_PLUS_ONE_PROMOTION);
        Product cider = new Product("사이다", 1_000, 10, null);

        assertThat(coke).isEqualTo(new Product("콜라", 1_000, 10, Constants.TWO_PLUS_ONE_PROMOTION));
